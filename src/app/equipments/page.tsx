...
export const metadata: Metadata = {
  ...
  description:
    "കനിവ് ചാരിറ്റി ട്രസ്റ്റിൽ ലഭ്യമായ വൈദ്യുപകരണങ്ങൾ - വീൽചെയർ, വാക്കർ, കമോഡ് കസേര, ഓക്സിജൻ സിലിണ്ടർ, എയർ ബെഡ് എന്നിവ ഉപയോഗത്തിനായി നൽകുന്നു. ഉപയോഗശേഷം തിരികെ നൽകേണ്ടതാണ്.",
}
        ...
        <div className="container mx-auto px-4 relative">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-base md:text-lg text-gray-600 leading-relaxed max-w-2xl mx-auto">
               രോഗികൾക്കും പ്രായമായവർക്കും ആവശ്യമായ വിവിധ മെഡിക്കൽ ഉപകരണങ്ങൾ ഞങ്ങളുടെ ട്രസ്റ്റിൽ ലഭ്യമാണ്. ആവശ്യമുള്ളവർക്ക് ഉപയോഗത്തിനായി നൽകുന്നു. ഉപയോഗശേഷം തിരികെ നൽകേണ്ടതാണ്.
            </p>
          </div>
        </div>
      </section>
