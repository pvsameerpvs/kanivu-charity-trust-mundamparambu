...
export default function FloatingWhatsApp() {
  ...
  if (pathname === "/upi-payment") return null;
  ...
  return (
    <motion.a
      ...
      className="fixed bottom-4 right-4 md:bottom-6 md:right-6 z-50 w-14 h-14 md:w-16 md:h-16 rounded-full bg-[#25D366] flex items-center justify-center shadow-xl hover:shadow-2xl hover:scale-110 transition-all duration-300"
    >
